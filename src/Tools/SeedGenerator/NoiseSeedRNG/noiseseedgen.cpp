...
static unsigned int randNoise(unsigned int position, unsigned int seed)
{
    unsigned int PRIME1 = 0x75BD0FB;
    unsigned int PRIME2 = 0x75BD12D;
...
// Initialise variables with defaults if values are not supplied
    ...
    for (int i = 0; i < n_samples; ++i) {
        int32_t gen = randNoise(i+1000000, mersseed());
