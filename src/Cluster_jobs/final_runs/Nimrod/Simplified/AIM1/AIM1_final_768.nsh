...
#
#Job name for ease of recognition: SLiM AIM1 513-768
#PBS -N SLiMA1-768
#
# Special Queue
#PBS -q Special
...
#NIM parameter LS integer range from 513 to 768 step 1
...
cat /${TMPDIR}/out_8T_null_means.csv >> /30days/${USER}/out_8T_null_means_768.csv

cat /${TMPDIR}/out_8T_null_muts.csv >> /30days/${USER}/out_8T_null_muts_768.csv

cat /${TMPDIR}/out_8T_null_chr.csv >> /30days/${USER}/out_8T_null_chr_768.csv

cat /${TMPDIR}/out_8T_null_burnin.csv >> /30days/${USER}/out_8T_null_burnin_768.csv
