...
#
#Job name for ease of recognition: SLiM AIM1 769-1024
#PBS -N SLiMA1-1024
#
# Special Queue
#PBS -q Special
...
#NIM parameter LS integer range from 769 to 1024 step 1
...
cat /${TMPDIR}/out_8T_null_means.csv >> /30days/${USER}/out_8T_null_means_1024.csv

cat /${TMPDIR}/out_8T_null_muts.csv >> /30days/${USER}/out_8T_null_muts_1024.csv

cat /${TMPDIR}/out_8T_null_chr.csv >> /30days/${USER}/out_8T_null_chr_1024.csv

cat /${TMPDIR}/out_8T_null_burnin.csv >> /30days/${USER}/out_8T_null_burnin_1024.csv
