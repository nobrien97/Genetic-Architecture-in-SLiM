...
if (PBSIND == 1) {
  ...
  system.time(system("/home/$USER/SLiM/slim -s 123 -d locisigma=10.0 -d pleiorate=0.5 -d delmu=1.0 -d rwide=1.241e-4 -d pleio_cov=0.5 /home/$USER/SLiM/Scripts/speedtest/Simplif/stabsel_recom_8T100L_nowrite.slim"))
}