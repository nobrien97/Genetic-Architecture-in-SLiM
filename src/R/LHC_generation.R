...
# May fix this at 0.1 * rwide: can't go much higher on the max recombination, it'll get too slow, and recombination rates 
...
# Strength of selection (s): multiplier for fitness function: ranges from 1 to 100 (weak to very strong selection)
